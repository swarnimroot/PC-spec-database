...
- Investigate aa18250 (Dell) `Core Ultra 9 290HX Plus` — verify against vendor page; either rename catalog stub + re-enqueue, or fix scraper. Stub left at `needs-review` (id 4 dropped Session 23)
